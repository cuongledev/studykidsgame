package com.cuongle.studykidsgame.ui.group_play;
...
public class GroupPlayFragment extends Fragment implements View.OnClickListener {
    LinearLayout cv_one,cv_two,cv_three,cv_four,cv_five,cv_six,cv_seven,cv_eight;
    private GroupPlayViewModel mViewModel;

    public static GroupPlayFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
         ...
         View root = inflater.inflate(R.layout.fragment_group_play, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(GroupPlayViewModel.class);
